...
#define SQL_AddRule(RULE)  "INSERT INTO RULE (ID,RULENAME,PROGRAMNAME,PROGRAMTITLE,PROGRAMDIRECTORY,RUNPATH,RUNNINGRULE,STARTTIMESEC,STARTTIMEUSEC,ENDTIMESEC,ENDTIMEUSEC,PERPERIODTIME,TIMES,TOTALTIMESEC,TOTALTIMEUSEC,LIMITRULE) VALUES (NULL,'"\
